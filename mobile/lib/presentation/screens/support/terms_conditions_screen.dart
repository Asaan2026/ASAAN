                  ...
                  children: [
                    ...
                    _buildSection(
                      title: '1. Acceptance of Terms',
                        content:
                          'By accessing and using Asaan Store, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.',
                      isDark: isDark,
                    ),
                    ...
                    _buildSection(
                      title: '2. Use License',
                        content:
                          'Permission is granted to temporarily download one copy of the materials on Asaan Store\'s app for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:\n\n• Modify or copy the materials\n• Use the materials for any commercial purpose\n• Attempt to decompile or reverse engineer any software\n• Remove any copyright or proprietary notations\n• Transfer the materials to another person',
                      isDark: isDark,
                    ),
                    ...
                    _buildSection(
                      title: '3. Account Terms',
                        content:
                          'You are responsible for maintaining the security of your account and password. Asaan Store cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.\n\nYou must provide accurate and complete information when creating your account. You are fully responsible for all activities that occur under your account.',
                      isDark: isDark,
                    ),
                    ...
                    _buildSection(
                      title: '9. Limitation of Liability',
                        content:
                          'In no event shall Asaan Store or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use Asaan Store.',
                      isDark: isDark,
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'By using Asaan Store, you acknowledge that you have read and understood these Terms and Conditions.',
                              style: TextStyle(
                                fontSize: 14,
                                color: isDark
                                    ? const Color(0xFF9CA3AF)
